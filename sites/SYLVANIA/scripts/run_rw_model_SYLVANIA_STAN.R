## This script uses the output from build_data to run the STAN model
## appropriate for the site, according to whether or not there are census
## data. Besides the model name, everything below "full model" should stay
...
## The site chosen to "borrow" measurement error from is Huron Mountain Club
...
load('~/Google Drive 2/McLachlan/SU20/ring_model_t_pdbh_HMC_NOCOVAR_v3.0.Rdata')
