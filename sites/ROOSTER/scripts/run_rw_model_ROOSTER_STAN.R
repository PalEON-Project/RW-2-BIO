...
out = readRDS(paste0('sites/HMC/output/ring_model_t_pdbh_NOCOVAR_v3.0.RDS'))
...
compiled <- stan_model(file = paste0('sites/', site, '/models/ring_model_t_pdbh_sigd_STAN.stan'))
